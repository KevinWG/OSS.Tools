...
namespace OSS.Tools.DataFlow
{
    ...
    public static class DataFlowFactory
    {
        ...
        /// <returns></returns>
        public static IDataPublisher<TData> CreateFlow<TData>(IDataSubscriber<TData> subscriber, string flowKey="task_flow", DataFlowOption option=null) 
        {
        ...
        /// <param name="option"></param>
        /// <returns></returns>
        public static IDataPublisher<TData> CreateFlow<TData>(Func<TData, Task<bool>> subscribeFunc, string flowKey = "task_flow", DataFlowOption option = null)
        {
        ...
        public static IDataPublisher<TData> CreatePublisher<TData>( string flowKey = "task_flow",DataPublisherOption option=null)
        {
